...
snapshot_download(
    ...
    local_dir="D:/RecAI/RecAI-main/InteRecAgent/hf_model/gte-base"
    resume_download=True
)

snapshot_download(
    repo_id="sentence-transformers/all-mpnet-base-v2",
    local_dir="D:/RecAI/RecAI-main/InteRecAgent/hf_model/all-mpnet-base-v2",
    resume_download=True
)
"""
# import httpx
...
parser.add_argument(
    ...
    help="Engine of OpenAI API to use. The default is gpt-3.5-turbo",
)
parser.add_argument(
    "--bot_type",
    type=str,
