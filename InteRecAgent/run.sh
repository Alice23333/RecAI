...
API_BASE="https://api.openai.com/v1" # [https://xxxx.azure.com, https://api.openai.com/v1]
API_VERSION="2023-03-15-preview"
API_TYPE="open_ai" # ['open_ai', 'azure']
engine=#"gpt-4" #"gpt-5.2"   # model name for OpenAI or deployment name for Azure OpenAI. GPT-4 is recommended.
