...
# from langchain_classic.agents import (AgentExecutor, LLMSingleActionAgent, Tool)
...
class CRSAgent:
    ...
    def __init__(self, domain: str, tools: Dict[str, Callable], candidate_buffer, item_corups, engine: str='gpt-3.5-turbo',# 'text-davinci-003', 
